...
{{< timeline >}}
    ...
    {{< timelineItem icon="check" header="eLearnSecurity Junior Pentester" subheader="" >}}
        Unfortunately, this doesn't have a Credly or similar - it previously went to <a>https://verified.elearnsecurity.com/certificates/16c74524-38c7-441c-be6e-dc0bfd13239b</a>, but eLearnSecurity was acquired by INE, and so the domain is no longer valid.
    {{< /timelineItem >}}

    {{< timelineItem icon="check" header="Offensive Security Certified Professional" subheader="Issued Feb. 2019" >}}
        <a href="https://www.credential.net/812e40c6-f516-417f-a07d-e79407296a26#acc.9gyiIwvO" target="_blank">https://www.credential.net/812e40c6-f516-417f-a07d-e79407296a26#acc.9gyiIwvO</a>
    {{< /timelineItem >}}
